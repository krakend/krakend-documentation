...
The gateway will default sending an HTTP status 200 if the backend returns a 200 or a 201. You can [change this strategy](/docs/v2.2/backends/detailed-errors/)
...
The gateway will default send a 500 HTTP status code if the backend returns any status above 400. You can [change this strategy](/docs/v2.2/backends/detailed-errors/).
