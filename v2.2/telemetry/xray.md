...
The Opencensus exporter allows you export data to AWS X-Ray. Enabling it only requires you to add the `xray` exporter in the [opencensus module](/docs/v2.2/telemetry/opencensus/).
...
{{< schema version="v2.2" data="telemetry/opencensus.json" property="exporters" filter="xray" >}}
