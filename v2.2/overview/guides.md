...
{{< button-group >}}
{{< button url="https://github.com/krakendio/krakend-documentation/edit/master/overview/guides.md" text="Add a link" >}}<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
