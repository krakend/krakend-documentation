...
Successfully setting the client credentials for a backend means that KrakenD can get the protected content. Still, the endpoint offered to the end-user will be public unless you protect it with [JWT](/docs/v2.2/authorization/jwt-overview/) or another end-user authentication mechanism.
...
{{< schema version="v2.2" data="auth/client-credentials.json" >}}
