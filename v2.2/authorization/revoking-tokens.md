...
**When using the Enterprise edition** the [Revoke Server](/docs/v2.2/enterprise/authentication/revoke-server/) connects to all KrakenD instances as a client, and there's nothing you need to build to make it work.
...
If you use the bloom filter together with the Revoken Server {{< badge >}}Enterprise{{< /badge >}}, see [its configuration](/docs/v2.2/enterprise/authentication/revoke-server/).
...
- [Revoke Server](/docs/v2.2/enterprise/authentication/revoke-server/) {{< badge color="denim">}}Enterprise{{< /badge >}}
