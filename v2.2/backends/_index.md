...
The `url_pattern` accepts `{variables}` from the endpoint definition, and on {{< badge color="denim" >}}Enterprise{{< /badge >}} you can also [inject headers](/docs/v2.2/enterprise/endpoints/dynamic-routing/) with patterns like `/{input_headers.X-Tenant}/foo`
