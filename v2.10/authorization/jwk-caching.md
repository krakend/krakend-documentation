...
meta:
  ...
  - "[SERVICE: JOSE]"
---
The [JWT validation](/docs/v2.10/authorization/jwt-validation/) and [JWT signing](/docs/v2.10/authorization/jwt-signing/) components do not apply cache by default.
