...
- Push metrics to [InfluxDB](/docs/v2.10/telemetry/influxdb/)
- Pull metrics from [Prometheus](/docs/v2.10/telemetry/prometheus/)
- Push metrics to [Datadog](/docs/v2.10/telemetry/datadog/)
- Push metrics to [Zipkin](/docs/v2.10/telemetry/zipkin/)
- Push metrics to [Jaeger](/docs/v2.10/telemetry/jaeger/)
- Push metrics to [Azure Monitor](/docs/v2.10/telemetry/azure/)