...
- Accept the `OPTIONS` method, adding the [flag `auto_options`](/docs/v2.10/service-settings/router-options/#auto_options)
- Add [CORS](/docs/v2.10/service-settings/cors/)
