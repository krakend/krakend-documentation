...
Martian works perfectly in combination with other components, such as [CEL verifications](/docs/v2.10/endpoints/common-expression-language-cel/) or [Caching](/docs/v2.10/backends/caching/), as it acts before other components start processing.
...
{{< schema version="v2.10" data="modifier/martian.json" property="body.Modifier" >}}
...
The [Flexible Configuration](/docs/v2.10/configuration/flexible-config/) has a `b64enc` function that will allow you to have an easier-to-read configuration. For instance (notice the backticks as delimiters):
...
{{< schema version="v2.10" data="modifier/martian.json" property="querystring.Modifier" >}}
