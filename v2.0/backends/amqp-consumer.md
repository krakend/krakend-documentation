...
To create Async agents that consume messages asynchronously and without requiring a user request, see [Async Agents](/docs/v2.0/async/).
...
See [Async Agents](/docs/v2.0/async/) to consume messages without an endpoint.
