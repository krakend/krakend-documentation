...
meta:
  ...
  - backend
---
The [krakend-martian](https://github.com/krakend/krakend-martian) component allows you to **transform requests and responses** through a simple DSL definition in the configuration file. Martian works perfectly in combination with [CEL verifications](/docs/v2.0/endpoints/common-expression-language-cel/).
