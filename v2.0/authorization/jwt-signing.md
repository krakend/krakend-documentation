...
- `kid`: *string*. The key ID purpose is to match a specific key, as the jwk_url might contain several keys (see [JWT validation](/docs/v2.0/authorization/jwt-validation/))
