...
More specifically, if you inject your plugin, you don't have [Client Credentials](/docs/v2.12/authorization/client-credentials/), [Backend Cache](/docs/v2.12/backends/caching/), or [Backend Telemetry](/docs/v2.12/telemetry/opentelemetry-layers-metrics/#data-exposed-in-the-backend-layer) unless you add this logic to your plugin.
{{< /note >}}
...
Read the introduction to [writing plugins](/docs/v2.12/extending/writing-plugins/) for compilation and configuration options if you haven't done it yet.
{{< /note >}}
...
If you are using Docker and want to load your plugin on Docker, compile it in the [Plugin Builder](/docs/v2.12/extending/writing-plugins/#plugin-builder) for easier integration.
