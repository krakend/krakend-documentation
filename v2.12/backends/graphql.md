...
{{< schema version="v2.12" data="backend/graphql.json" >}}
...
- Accept the `OPTIONS` method, adding the [flag `auto_options`](/docs/v2.12/service-settings/router-options/#auto_options)
