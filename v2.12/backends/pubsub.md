...
{{< schema version="v2.12" data="backend/pubsub/subscriber.json" >}}
...
{{< schema version="v2.12" data="backend/pubsub/publisher.json" >}}
...
Rabbit can alternatively be configured using the [AMQP component](/docs/v2.12/backends/amqp-consumer/).
