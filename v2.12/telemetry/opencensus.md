...
KrakenD has traditionally offered its telemetry integration through this **OpenCensus** component, which has provided reliable service for over six years, but now has transitioned to the more modern and robust [OpenTelemetry](/docs/v2.12/telemetry/opentelemetry/) framework.

As a result of a change in the industry, the OpenCensus integration is deprecated, and all efforts are focused on [OpenTelemetry](/docs/v2.12/telemetry/opentelemetry/). Move away from this component.
{{< /note >}}
...
{{< schema version="v2.12" data="telemetry/opencensus.json" norecurse="exporters">}}



## Transition from OpenCensus
If you have been using telemetry on KrakenD for the past six years (before KrakenD 2.6), you were using the [OpenCensus](/docs/v2.12/telemetry/opencensus/) exporters, which have worked like a Swiss clock.
