...
{{< schema version="v2.12" data="async_agent.json" property="items" title="Properties of an Async Agent object" >}}

Do not forget to [set the driver for the Async agent](/docs/v2.12/async/amqp/) inside the `extra_config`.
...
Check [how agents report in the health endpoint](/docs/v2.12/service-settings/health/)
