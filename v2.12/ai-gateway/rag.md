...
As per today, the usage of RAG requires you to make manual use of the [sequential proxy](/docs/v2.12/endpoints/sequential-proxy/) and implement the flow in the configuration.
...
See the [Sequential Proxy](/docs/v2.12/endpoints/sequential-proxy/) and [Workflow](/docs/enterprise/endpoints/workflows/#content) components to implement this logic.
