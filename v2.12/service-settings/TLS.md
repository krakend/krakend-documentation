...
- [Use a balancer with TLS termination in front of KrakenD](/docs/v2.12/throttling/load-balancing/) (e.g., ELB, HAproxy)
...
If you want to enable mTLS see [Mutual TLS configuration](/docs/v2.12/authorization/mutual-authentication/)
...
{{< schema version="v2.12" data="tls.json" >}}
...
{{< schema version="v2.12" data="client_tls.json" >}}
