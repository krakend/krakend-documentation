...
{{< schema version="v2.3" data="router.json" >}}
...
This option does not relate to the body of your backend errors. If you are looking for this option, see [return detailed errors](/docs/v2.3/backends/detailed-errors/#showing-backend-errors) instead.
{{< /note >}}
