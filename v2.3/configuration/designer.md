...
Combined with a [`:watch` container](/docs/v2.3/developer/hot-reload/), you can **administer and apply configuration changes automatically** in a development environment.
...
You can check that KrakenD is running by visiting its [health endpoint](/docs/v2.3/service-settings/health/): http://localhost:8080/__health
