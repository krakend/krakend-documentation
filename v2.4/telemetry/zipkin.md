...
The Opencensus exporter allows you export data to Zipkin. Enabling it only requires you to add the `zipkin` exporter in the [opencensus module](/docs/v2.4/telemetry/opencensus/).
...
{{< schema version="v2.4" data="telemetry/opencensus.json" property="exporters" filter="zipkin" >}}
