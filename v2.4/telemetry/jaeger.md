...
The Opencensus Jaeger exporter allows you to export spans to Jaeger. Enabling it only requires you to add the `jaeger` exporter in the [opencensus module](/docs/v2.4/telemetry/opencensus/). You can post spans using two different approaches:
...
You can find a running demo with Jaeger using docker compose on [KrakenD Playground](/docs/v2.4/overview/playground/).
...
{{< schema version="v2.4" data="telemetry/opencensus.json" property="exporters" filter="jaeger" >}}
