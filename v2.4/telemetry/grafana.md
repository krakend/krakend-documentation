...
For the data sources listed above, you will need to add the [InfluxDb exporter](/docs/v2.4/telemetry/influxdb/)into your `krakend.json`, which is a configuration like this:
...
For more in-depth explanation, see the [InfluxDB exporter configuration](/docs/v2.4/telemetry/influxdb/)
