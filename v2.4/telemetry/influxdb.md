...
meta:
  ...
  - "[SERVICE: Opencensus]"
---
KrakenD can expose very detailed metrics to provide a **monitoring dashboard**. One of the richest monitoring solutions at the metrics level is the combination of [Extended metrics](/docs/v2.4/telemetry/extended-metrics/) with the **native Influx** exporter. The two components let you send detailed metrics to InfluxDB and draw them later on our preconfigured [Grafana dashboard](/docs/v2.4/telemetry/grafana/).
...
{{< schema version="v2.4" data="telemetry/influx.json" >}}

See below how to configure InfluxDB, and you are ready to [publish a Grafana dashboard](/docs/v2.4/telemetry/grafana/).
...
{{< schema version="v2.4" data="telemetry/opencensus.json" property="exporters" filter="influxdb" >}}
