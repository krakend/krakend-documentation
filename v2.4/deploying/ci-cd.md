...
2. Optional - [Generate an immutable docker image](/docs/v2.4/deploying/docker/)
3. Optional - [Run integration tests](/docs/v2.4/developer/integration-tests/)
...
[Read more about the `check` command](/docs/v2.4/configuration/check/)