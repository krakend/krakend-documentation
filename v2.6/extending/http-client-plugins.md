...
More specifically, if you inject your plugin, you don't have [Client Credentials](/docs/v2.6/authorization/client-credentials/) or [Backend Cache](/docs/v2.6/backends/caching/), and you won't have telemetry at the HTTP backend level.
{{< /note >}}
...
If you are using Docker and want to load your plugin on Docker, compile it in the [Plugin Builder](/docs/v2.6/extending/writing-plugins/#plugin-builder) for easier integration.
