...
- [Introduction to custom plugins](/docs/v2.6/extending/)
- [Writing custom plugins](/docs/v2.6/extending/writing-plugins/)
...
If you want to test that a compiled plugin works (it loads), you can use the [`test-plugin` command](/docs/v2.6/extending/test-plugin/) once you have it compiled.
