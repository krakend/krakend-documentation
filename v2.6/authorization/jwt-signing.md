...
{{< schema version="v2.6" data="auth/signer.json" >}}
...
The [KrakenD Playground](/docs/v2.6/overview/playground/) demonstrates how to sign tokens in the `/token` endpoint and includes an example ready to use. To try it, [clone the playground](https://github.com/krakend/playground-community) and follow the README.
