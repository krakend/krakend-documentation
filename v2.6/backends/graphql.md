...
{{< schema version="v2.6" data="backend/graphql.json" >}}
...
- Accept the `OPTIONS` method, adding the [flag `auto_options`](/docs/v2.6/service-settings/router-options/#auto_options)
- Add [CORS](/docs/v2.6/service-settings/cors/)
