...
{{< schema version="v2.6" data="async_agent.json" property="items" title="Properties of an Async Agent object" >}}
...
Check [how agents report in the health endpoint](/docs/v2.6/service-settings/health/)
