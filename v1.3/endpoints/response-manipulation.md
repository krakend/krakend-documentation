...
- **[Deny list](/docs/v1.3/backends/data-manipulation#deny)**
- **[Allow list](/docs/v1.3/backends/data-manipulation#allow)**

See [filtering documentation](/docs/v1.3/backends/data-manipulation#filtering)
...
See [grouping documentation](/docs/v1.3/backends/data-manipulation#grouping)
...
See [mapping documentation](/docs/v1.3/backends/data-manipulation#mapping)
...
See [target documentation](/docs/v1.3/backends/data-manipulation#target)
...
See [collections documentation](/docs/v1.3/backends/data-manipulation#collections)