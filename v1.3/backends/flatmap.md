...
The flatmap middleware allows you to **manipulate collections** (or arrays, or lists, you name it). While the [basic manipulation operations](/docs/v1.3/backends/data-manipulation/) allow you to work directly with objects, the collections require a different approach: the **flatmap component**.
...
*   **Moving**, **embedding** or **extracting** items from one place to another (equivalent concepts to [`mapping`](/docs/v1.3/backends/data-manipulation/#mapping) and [`allow`](/docs/v1.3/backends/data-manipulation/#allow))
*   **Deleting** specific items (similar concept to [`deny`](/docs/v1.3/backends/data-manipulation/#deny))
*   **Appending** items from one list to the other

{{< note title="Important" >}}
Use a basic [data manipulation](/docs/v1.3/backends/data-manipulation/) operation such as [`target`](/docs/v1.3/backends/data-manipulation/#target), [`deny`](/docs/v1.3/backends/data-manipulation/#deny) or [`allow`](/docs/v1.3/backends/data-manipulation/#allow) whenever it fits as their computational cost is lower.
...
*   Since `a` is an array (`"a": []`) we need to use the flatmap component. If it were an object (`"a": {}`) we would use [deny or allow](/docs/v1.3/backends/data-manipulation/)
