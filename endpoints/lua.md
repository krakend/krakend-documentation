...
A [Go plugin](/docs/enterprise/extending/writing-plugins/) {{< badge >}}Enterprise{{< /badge >}} delivers much more speed and power than a Lua script for performance-first seeking users, but requires you to compile your plugins and side-load them on KrakenD.
{{< /note >}}
