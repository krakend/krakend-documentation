...
That's the basic structure of endpoints; for more information see [how to create endpoints](/docs/v1.4/endpoints/).
...
For instance, the [extended logging component](/docs/v1.4/logging/) uses the **namespace** `github_com/devopsfaith/krakend-gologging`:
{{< highlight JSON >}}
{
    "version": 2,
    "extra_config": {
