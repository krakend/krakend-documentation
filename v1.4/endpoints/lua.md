...
Scripting with Lua is an additional choice to extend your business logic, and is compatible with the rest of options such as [CEL](/docs/v1.4/endpoints/common-expression-language-cel/), [Martian](/docs/v1.4/backends/martian/), or other Go plugins and middlewares.
