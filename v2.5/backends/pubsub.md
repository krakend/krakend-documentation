...
{{< schema version="v2.5" data="backend/pubsub/subscriber.json" >}}
...
{{< schema version="v2.5" data="backend/pubsub/publisher.json" >}}
...
Rabbit can alternatively be configured using the [AMQP component](/docs/v2.5/backends/amqp-consumer/).
