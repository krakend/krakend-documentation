...
```json
{
    "$schema": "https://www.krakend.io/schema/v2.9/backend_extra_config.json",
    "qos/ratelimit/proxy": {
        "max_rate": 100,
        "capacity": 100
    },
