...
After the installation completes go to [Using KrakenD](/docs/v2.9/overview/run/)
...
You can also [download](/download/) the `tar.gz` and decompress it anywhere. Instructions to check the SHA and PGP signature [here](/docs/v2.9/overview/verifying-packages/).
