...
{{< schema version="v2.9" data="backend/graphql.json" >}}
...
- Accept the `OPTIONS` method, adding the [flag `auto_options`](/docs/v2.9/service-settings/router-options/#auto_options)
- Add [CORS](/docs/v2.9/service-settings/cors/)
