...
**Important**: Connections not having a recognized certificate in KrakenD's system CA, will be rejected. For further documentation on TLS, see the [TLS documentation](/docs/v2.11/service-settings/tls/)
...
{{< schema version="v2.11" data="client_tls.json" filter="client_certs" >}}
