...
meta:
  ...
  - "[SERVICE: JOSE]"
---
The [JWT validation](/docs/v2.11/authorization/jwt-validation/) and [JWT signing](/docs/v2.11/authorization/jwt-signing/) components do not apply cache by default.
...
{{< schema version="v2.11" data="auth/validator.json" filter="cache,cache_duration" >}}
...
{{< schema version="v2.11" data="auth/jose.json" >}}
