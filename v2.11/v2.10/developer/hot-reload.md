...
When you use [flexible configuration](/docs/v2.11/v2.10/configuration/flexible-config/), you can pass the environment variables when starting the container. For instance:
