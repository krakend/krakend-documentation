...
[Descope](https://www.descope.com/) is a passwordless authentication and user management service designed for developers. KrakenD integrates with Descope via the [JWT validation](/docs/v2.11/v2.10/authorization/jwt-validation/) component.
...
For more details, see [KrakenD's JWT Validation documentation](/docs/v2.11/v2.10/authorization/jwt-validation/).
