...
When you declare in the configuration file any of the HTTP server settings declared above, you can [override its value through environment variables](/docs/v2.11/v2.10/configuration/environment-vars/) when starting the server.
