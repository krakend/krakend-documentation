...
The Opencensus exporter allows you to export **metrics and traces** to Google Cloud. Enabling it only requires you to add the `stackdriver` exporter in the [opencensus module](/docs/v2.11/v2.10/telemetry/opencensus/).
...
{{< schema version="v2.10" data="telemetry/opencensus.json" property="exporters" filter="stackdriver" >}}
