...
[Here you will find the results of the benchmarks](/docs/v2.11/v2.10/benchmarks/local/)

### Benchmark in Amazon AWS EC2 Instances

[Here you will find the results of the benchmarks](/docs/v2.11/v2.10/benchmarks/aws/)

### API Gateway Benchmark

[Here you will find the results of the comparisons](/docs/v2.11/v2.10/benchmarks/api-gateway-benchmark/)
