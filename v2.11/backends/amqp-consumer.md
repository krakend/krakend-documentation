...
To create Async agents that consume messages asynchronously and without requiring a user request, see [Async Agents](/docs/v2.11/async/).
...
See [Async Agents](/docs/v2.11/async/) to consume messages without an endpoint.
...
{{< schema version="v2.11" data="backend/amqp/consumer.json" >}}
