...
Combined with a [`:watch` container](/docs/v2.11/developer/hot-reload/), you can **apply configuration changes automatically** in a development environment.
...
You can check that KrakenD is running by visiting its [health endpoint](/docs/v2.11/service-settings/health/): http://localhost:8080/__health
...
The Designer does not support [flexible configuration](/docs/v2.11/configuration/flexible-config/), as the browser cannot render Go templates of a complex directory structure.
