...
- Having a [balancer in front of the machines](/docs/v2.7/throttling/load-balancing/) (e.g., ELB, Haproxy, Kubernetes...)
...
For best practices deploying KrakenD, see [Deploying KrakenD](/docs/v2.7/deploying/)
