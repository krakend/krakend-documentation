...
2. Optional - Ensure there are no severe security problems using the [`audit` command](/docs/v2.7/configuration/audit/).
3. Optional - [Generate an immutable docker image](/docs/v2.7/deploying/docker/)
4. Optional - [Run integration tests](/docs/v2.7/developer/integration-tests/)
...
[Read more about the `check` command](/docs/v2.7/configuration/check/)
