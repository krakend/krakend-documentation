...
## PGP
We will check the detached signature [PGP]({{< product download_repo >}}/bin/krakend_2.7_amd64_generic-linux.tar.gz.asc) against our package [KrakenD]({{< product download_repo >}}/bin/krakend_2.7_amd64_generic-linux.tar.gz).

{{< terminal title="Term" >}}
gpg --verify krakend_2.7_amd64_generic-linux.tar.gz.asc krakend_2.7_amd64_generic-linux.tar.gz
...
To make sure the binary downloaded matches our SHA256 ensure the next 2 commands produce the same [SHA]({{< product download_repo >}}/bin/krakend_2.7_amd64_generic-linux.tar.gz.sha256) output.

{{< terminal title="Term" >}}
shasum -a 256 -b krakend_2.7_amd64_generic-linux.tar.gz
{{< /terminal >}}

Compare it to:
{{< terminal title="Term" >}}
curl {{< product download_repo >}}/bin/krakend_2.7_amd64_generic-linux.tar.gz.sha256
{{< /terminal >}}