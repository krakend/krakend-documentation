...
{{< schema version="v2.7" data="backend/pubsub/subscriber.json" >}}
...
{{< schema version="v2.7" data="backend/pubsub/publisher.json" >}}
...
Rabbit can alternatively be configured using the [AMQP component](/docs/v2.7/backends/amqp-consumer/).
