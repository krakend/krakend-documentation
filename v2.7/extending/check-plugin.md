...
- [Introduction to custom plugins](/docs/v2.7/extending/)
- [Writing custom plugins](/docs/v2.7/extending/writing-plugins/)
...
If you want to test that a compiled plugin works (it loads), you can use the [`test-plugin` command](/docs/v2.7/extending/test-plugin/) once you have it compiled.
