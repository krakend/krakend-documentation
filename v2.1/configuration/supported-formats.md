...
Validate the syntax with [`krakend check`](/docs/v2.1/configuration/check/)
...
**Flexible Configuration**: If you want to split the configuration file into different pieces or use variables inside the configuration, the [flexible configuration](/docs/v2.1/configuration/flexible-config/) needs `JSON`.
