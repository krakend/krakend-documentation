...
{{< schema version="v2.1" data="backend/pubsub/subscriber.json" >}}
...
{{< schema version="v2.1" data="backend/pubsub/publisher.json" >}}
...
Rabbit can alternatively be configured using the [AMQP component](/docs/v2.1/backends/amqp-consumer/).
