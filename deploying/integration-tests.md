...
title: Running your integration tests
menu:
  community_current:
    parent: "110 Deploying"
weight: 30
---
In addition to checking the syntax of your KrakenD configuration, you might want to send real requests to the gateway to make sure all endpoints are properly connected and that they reply with the expected content. To do that, you can use any library that helps you fire requests to KrakenD, or you can use our simple library of integration tests in KrakenD that might help you quickly accomplish that.
...
- `out`: The expected response from the gateway
	...
	- `header`: Any header included in the response
