...
[Here you will find the results of the benchmarks](/docs/v2.8/benchmarks/local/)

### Benchmark in Amazon AWS EC2 Instances

[Here you will find the results of the benchmarks](/docs/v2.8/benchmarks/aws/)

### API Gateway Benchmark

[Here you will find the results of the comparisons](/docs/v2.8/benchmarks/api-gateway-benchmark/)
