...
Martian works perfectly in combination with other components, such as [CEL verifications](/docs/v2.8/endpoints/common-expression-language-cel/) or [Caching](/docs/v2.8/backends/caching/), as it acts before other components start processing.
...
{{< schema version="v2.8" data="modifier/martian.json" property="body.Modifier" >}}
...
The [Flexible Configuration](/docs/v2.8/configuration/flexible-config/) has a `b64enc` function that will allow you to have an easier-to-read configuration. For instance (notice the backticks as delimiters):
...
{{< schema version="v2.8" data="modifier/martian.json" property="cookie.Modifier" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="url.Modifier" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="querystring.Modifier" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.Copy" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="stash.Modifier" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.Modifier" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.Id" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.Append" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.Blacklist" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="port.Modifier" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="cookie.Filter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="url.Filter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="url.RegexFilter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="querystring.Filter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.Filter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="header.RegexFilter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="port.Filter" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="fifo.Group" >}}
...
{{< schema version="v2.8" data="modifier/martian.json" property="priority.Group" >}}
