...
If you don't want to parse the access log on Logstash, you can remove it from the stdout using `disable_access_log` (see how to [remove requests from logs options](/docs/v2.8/service-settings/router-options/#remove-requests-from-logs)).
