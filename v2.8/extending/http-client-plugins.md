...
More specifically, if you inject your plugin, you don't have [Client Credentials](/docs/v2.8/authorization/client-credentials/) or [Backend Cache](/docs/v2.8/backends/caching/), and you won't have telemetry at the HTTP backend level.
{{< /note >}}
...
Read the introduction to [writing plugins](/docs/v2.8/extending/writing-plugins/) for compilation and configuration options if you haven't done it yet.
{{< /note >}}
...
If you are using Docker and want to load your plugin on Docker, compile it in the [Plugin Builder](/docs/v2.8/extending/writing-plugins/#plugin-builder) for easier integration.
