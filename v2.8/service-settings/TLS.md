...
- [Use a balancer with TLS termination in front of KrakenD](/docs/v2.8/throttling/load-balancing/) (e.g., ELB, HAproxy)
...
If you want to enable mTLS see [Mutual TLS configuration](/docs/v2.8/authorization/mutual-authentication/)
...
{{< schema version="v2.8" data="tls.json" >}}
...
{{< schema version="v2.8" data="client_tls.json" >}}
