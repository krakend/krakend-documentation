...
Examples of service settings are, the [listening port](/docs/v2.8/service-settings/http-server-settings/), [disabling keep alives](/docs/v2.8/service-settings/http-transport-settings/), enabling [metrics and traces](/docs/v2.8/telemetry/), [listening https](/docs/v2.8/service-settings/tls/), or enabling [CORS](/docs/v2.8/service-settings/cors/) to name a few.

If you haven't done it yet, read [ Understanding the configuration file](/docs/v2.8/configuration/structure/).
...
{{< schema version="v2.8" data="krakend.json" filter="version,extra_config,port,listen_ip,endpoints,output_encoding,timeout,host,cache_ttl">}}
...
- [Router settings](/docs/v2.8/service-settings/router-options/)
- [SSL/TLS](/docs/v2.8/service-settings/tls/)
