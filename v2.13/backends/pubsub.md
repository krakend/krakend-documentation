...
{{< schema version="v2.13" data="backend/pubsub/subscriber.json" >}}
...
{{< schema version="v2.13" data="backend/pubsub/publisher.json" >}}
...
Rabbit can alternatively be configured using the [AMQP component](/docs/v2.13/backends/amqp-consumer/).
