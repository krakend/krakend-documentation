...
{{< schema version="v2.13" data="async_agent.json" property="items" title="Properties of an Async Agent object" >}}

Do not forget to [set the driver for the Async agent](/docs/v2.13/async/amqp/) inside the `extra_config`.
...
Check [how agents report in the health endpoint](/docs/v2.13/service-settings/health/)
