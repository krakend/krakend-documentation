...
{{< schema version="v2.13" data="security/cors.json" >}}
...
To support `OPTIONS` in your endpoints, you only need to add the [flag `auto_options`](/docs/v2.13/service-settings/router-options/#auto_options) as follows:
...
```
{{< schema version="v2.13" data="router.json" filter="auto_options" >}}
