...
The [OpenTelemetry integration](/docs/v2.13/telemetry/opentelemetry/) allows you to send **metrics and traces** to Datadog using their collector.
...
In addition, you can configure how the `layers` behave ([see all options](/docs/v2.13/telemetry/opentelemetry/#layers)).
