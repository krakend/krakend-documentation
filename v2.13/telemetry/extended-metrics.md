...
{{< schema version="v2.13" data="telemetry/metrics.json" >}}
...
{{< schema version="v2.13" data="telemetry/influx.json" >}}

See below how to configure InfluxDB, and you are ready to [publish a Grafana dashboard](/docs/v2.13/telemetry/grafana/).
