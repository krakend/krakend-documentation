...
The OpenTelemetry configuration is declared [at the service level](/docs/v2.13/telemetry/opentelemetry/), but you can override metrics and traces per endpoint and per backend as follows.
...
{{< schema version="v2.13" data="telemetry/opentelemetry-endpoint.json" filter="proxy" title="OpenTelemetry settings per endpoint">}}
...
{{< schema version="v2.13" data="telemetry/opentelemetry-backend.json" title="OpenTelemetry settings per backend" >}}
