...
- Having a [balancer in front of the machines](/docs/v2.13/throttling/load-balancing/) (e.g., ELB, Haproxy, Kubernetes...)
...
For best practices deploying KrakenD, see [Deploying KrakenD](/docs/v2.13/deploying/)
