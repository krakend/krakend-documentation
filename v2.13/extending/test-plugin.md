...
When you upgrade KrakenD to another version you must recompile your plugins using the [builder matching the version](/docs/v2.13/extending/writing-plugins/#plugin-builder).
{{< /note >}}
...
If you encounter issues, consider using the [check-plugin](/docs/v2.13/extending/check-plugin/) tool during development to diagnose and resolve problems effectively.