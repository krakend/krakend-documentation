...
If you are using Docker and wanting to load your plugin on Docker, compile it in the [Plugin Builder](/docs/v2.13/extending/writing-plugins/#plugin-builder) for an easier integration.
...
As gateway errors are not propagated to the end-user, if you want them to see the defined error you must enable [`return_error_message`](/docs/v2.13/service-settings/router-options/#returning-the-gateway-error-message) as [router options](/docs/v2.13/service-settings/router-options/).
