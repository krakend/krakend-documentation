...
- `client-example.so`  (An [HTTP client plugin](/docs/v2.13/extending/http-client-plugins/))
- `server-example.so` (An [HTTP server plugin](/docs/v2.13/extending/http-server-plugins/))
- `request-modifier.so` (A [request/response modifier plugin](/docs/v2.13/extending/plugin-modifiers/))
