...
[Descope](https://www.descope.com/) is a passwordless authentication and user management service designed for developers. KrakenD integrates with Descope via the [JWT validation](/docs/v2.13/authorization/jwt-validation/) component.
...
docker run --rm -v "$PWD:/etc/krakend" -p "8080:8080" {{< product image >}}:2.13
{{< /terminal >}}
...
For more details, see [KrakenD's JWT Validation documentation](/docs/v2.13/authorization/jwt-validation/).
