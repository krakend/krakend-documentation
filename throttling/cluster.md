...
If you prefer not to use a stateless rate limit, the KrakenD Enterprise edition has a [stateful Redis-backed rate limit](/docs/enterprise/endpoints/global-rate-limit/) where counters are shared amongst all nodes.
{{< /note >}}
